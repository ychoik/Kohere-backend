 ...
 * {@code BOOKING_INVALID_MOVE_IN_DATE}(422)로 처리한다. 누락·형식 위반은 {@code INVALID_INPUT}(400) — 날짜를
 * {@code String}으로 받아 응용 계층이 파싱하므로 형식 오류도 어느 필드인지 {@code errors[]}에 실린다(#151).
 */
public record BookingRequest(
    @NotBlank String roomOfferId,
    @NotBlank String moveInDate,
